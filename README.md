...
- [Cygnus ☸️](#cygnus-️)
  ...
  - [🚀 Running the Project](#-running-the-project)
    - [Option A: Primary Web App (Recommended)](#option-a-primary-web-app-recommended)
  ...
  - [☸️ Testing Instructions](#️-testing-instructions)
    ...
    - [✅ Test 3: International Flight Detection (Core Feature)](#-test-3-international-flight-detection-core-feature)
